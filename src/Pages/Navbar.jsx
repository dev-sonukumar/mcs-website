...
export default function Navbar() {
  return (
    <header className="z-50 sticky top-0 left-0 h-24 text-[15px]  w-full flex flex-col gap-2 bg-white  shadow-lg">
      {/* -- Top nav bar -- */}
      <div className=" bg-[var(--main-color)] text-[var(--text-color)] w-full ">
        <div className="container mx-auto flex justify-center gap-10 items-center  px-12">
          <p className="text-[10px] text-white">Mob: +91-9315973373</p>
